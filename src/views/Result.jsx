...
const Result = () => {
  return (
    <main className="result-page">
      <Header to="/quiz1" showPracticeAgainBtn={true} />
      <section className="result-section">
        <div className="box">
          <div className="result-content">
            <img src={CelebrateImg} alt="CelebrateImg" />
            <h3>
              Congrats, you just made it! Let's take a moment to review your
              answers.
            </h3>
            <div className="result-box">
              <ResultAccordion
                resultNo="01/10"
                question="How did you handle the significant challenge?"
